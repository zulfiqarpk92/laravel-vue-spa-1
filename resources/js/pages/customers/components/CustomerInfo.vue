          ...
          <v-list-item class="px-0 mb-n2">
            <v-list-item-content>
              <v-list-item-title>
                ...
                <span class="text--secondary">{{ invoicesTotal }}</span>
              </v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item class="px-0 mb-n2">
            <v-list-item-content>
              <v-list-item-title>
                ...
                <span class="text--secondary">{{ paymentsTotal }}</span>
              </v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item class="px-0 mb-n2">
            <v-list-item-content>
              <v-list-item-title>
                ...
                <span class="text--secondary">{{ balanceTotal }}</span>
              </v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-list>
...
export default {
  ...
  computed: {
    invoicesTotal () {
      return this?.customerInfo?.invoices.reduce((total, inv) => total + inv.total_amount, 0)
    },
    paymentsTotal () {
      return this?.customerInfo?.payments.reduce((total, p) => total + p.amount, 0)
    },
    balanceTotal () {
