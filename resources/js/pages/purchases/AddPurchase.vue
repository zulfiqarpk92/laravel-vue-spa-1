  ...
  <v-row>
    ...
    <v-col cols="12" md="3">
      <v-card class="invoice-options">
        <v-card-text>
          <v-btn class="mb-3" block color="primary" @click="savePurchase">
            Save
          </v-btn>
          <v-btn class="mb-3" block color="primary" @click="savePurchase">
            Save as Draft
          </v-btn>
          <v-btn class="mb-3" block color="error" to="/purchases">
            Cancel
          </v-btn>
        </v-card-text>
      </v-card>
    ...
    savePurchase: function () {
      this.purchase
        ...
        .then(response => {
          ...
          this.$store.dispatch('snackbar/showMessage', response.message ?? 'Purchase created')
