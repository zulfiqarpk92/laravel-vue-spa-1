  ...
  <div>
    ...
    >
      <v-container class="py-0 fill-height">
        ...
        <span class="v-badge ms-4 v-badge--bottom v-badge--dot v-badge--overlap theme--light" @click="toggleDropdown">
          <div class="v-avatar v-avatar-light-bg primary--text primary" role="button" aria-haspopup="true" aria-expanded="false" style="height: 40px; min-width: 40px; width: 40px;">
            <div class="v-image v-responsive theme--light">
              ...
              <div class="v-image__image v-image__image--cover" style="background-image: url(&quot;https://demos.themeselection.com/materio-vuetify-vuejs-admin-template/demo-5/img/1.e2938115.png&quot;); background-position: center center;" />
              <div class="v-responsive__content" style="width: 200px;" />
            </div>
          </div>
        ...
        <div v-if="isDropdownOpen" role="menu" class="v-menu__content theme--light v-menu__content--fixed menuable__content__active user-profile-menu-content" style="min-width: 230px; top: 12px; left: 1071px; transform-origin: left top; z-index: 9;">
          <div class="v-list v-sheet theme--light">
            <div class="pb-3 pt-2">
              ...
              <div class="d-inline-flex flex-column justify-center ms-3" style="vertical-align: middle;">
                <span class="text--primary font-weight-semibold mb-n1"> John Doe </span><small class="text--disabled text-capitalize">admin</small>
              </div>
            </div>
            <hr role="separator" aria-orientation="horizontal" class="v-divider theme--light">
            <a id="list-item-383" href="/materio-vuetify-vuejs-admin-template/demo-5/apps/user/view/21" class="v-list-item v-list-item--link theme--light" tabindex="0" role="menuitem">
            ...
            <a id="list-item-395" href="/materio-vuetify-vuejs-admin-template/demo-5/pages/account-settings" class="v-list-item v-list-item--link theme--light" tabindex="0" role="menuitem">
              <div class="v-list-item__icon me-2">
                <span aria-hidden="true" class="v-icon notranslate theme--light" style="font-size: 22px; height: 22px; width: 22px;">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" class="v-icon__svg" style="font-size: 22px; height: 22px; width: 22px;">
            ...
            <div id="list-item-405" tabindex="0" role="menuitem" class="v-list-item v-list-item--link theme--light">
              <div class="v-list-item__icon me-2">
                <span aria-hidden="true" class="v-icon notranslate theme--light" style="font-size: 22px; height: 22px; width: 22px;">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" class="v-icon__svg" style="font-size: 22px; height: 22px; width: 22px;">
              ...
              <div class="v-list-item__content">
                <div v-if="user" class="v-list-item__title " text @click.prevent="logout">
                  {{ $t('logout') }}
                </div>
              </div>
            </div>
